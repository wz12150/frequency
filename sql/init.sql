...
CREATE TABLE RSBT_SPECIAL_PERMIT_STATION (
    GUID            VARCHAR(64)     NOT NULL PRIMARY KEY COMMENT '主键ID',
    PERMITID        VARCHAR(64)     NOT NULL COMMENT '授权主表ID',
    STATIONID       VARCHAR(64)     DEFAULT NULL COMMENT '关联台站ID(RSBT_STATION)',
    ...
    CONSTRAINT fk_station_ref FOREIGN KEY (STATIONID) REFERENCES RSBT_STATION(GUID) ON DELETE SET NULL
